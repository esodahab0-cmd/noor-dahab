...
3. قول كل فئة شفتها وعددها كام ورقة بالبلدي، واختم بجملة واضحة: "المجموع الإجمالي: [المبلغ] جنيه مصري". لو الورقة مش واضحة أو مقطوعة أو مش مصرية، حذر الكفيف فوراً.`;
    ...
    case "transit":
      return `${basePrompt}\nالمطلوب للمواصلات والشارع: اقرأ فوراً اليافطة اللي على مقدمة العربية أو الأتوبيس أو الميكروباص اللي قدامك، وقول رقم الخط ورايح فين بالظبط بالبلدي لمساعدة الكفيف في الشارع أو المحطة.`;
